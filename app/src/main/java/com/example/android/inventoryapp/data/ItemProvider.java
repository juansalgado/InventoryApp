...
public class ItemProvider extends ContentProvider {
    ...
    private Uri insertItem(Uri uri, ContentValues values) {
        ...
        Integer photo = values.getAsInteger(ItemEntry.COLUMN_ITEM_PHOTO);
        if (photo == null || !ItemEntry.isValidPhoto(photo)) {
    ...
    private int updateItem(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        // If the {@link ItemEntry#COLUMN_ITEM_PHOTO} key is present,
        // check that the photo value is valid.
        if (values.containsKey(ItemEntry.COLUMN_ITEM_PHOTO)) {
            Integer photo = values.getAsInteger(ItemEntry.COLUMN_ITEM_PHOTO);
            if (photo == null || !ItemEntry.isValidPhoto(photo)) {
                throw new IllegalArgumentException("Item requires valid photo");
            }
