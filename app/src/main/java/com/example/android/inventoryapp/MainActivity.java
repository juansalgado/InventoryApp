 ...
 * Displays list of items that were entered and stored in the
 * Rumble Dumble Fabulous Store.
 */
public class MainActivity extends AppCompatActivity implements
    ...
    public void onSaleClick(long id, int quantity) {
        ...
        int rowTarget = getContentResolver().update(currentItemUri, values, null, null);
    }
    ...
    private void insertItem() {
        ...
        // and default values.
        ContentValues values = new ContentValues();
        values.put(ItemEntry.COLUMN_ITEM_NAME, "Invisible \'M\' Powders");
        values.put(ItemEntry.COLUMN_EMAIL, "No email");
        values.put(ItemEntry.COLUMN_ITEM_PHOTO, ItemEntry.PHOTO00);
        values.put(ItemEntry.COLUMN_ITEM_PRICE, 1);
        values.put(ItemEntry.COLUMN_ITEM_QUANTITY, 0);

        // Insert a new row for Invisible Magic Powders into the provider using the ContentResolver.
